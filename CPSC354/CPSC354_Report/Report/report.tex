...
\node[below=1cm of a, xshift=1.25cm] {ARS \#3};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[->,>=stealth, node distance=2.5cm]
\node[circle,draw,minimum size=8mm] (a) {a};
\node[circle,draw,minimum size=8mm,above right of=a] (b) {b};
\node[circle,draw,minimum size=8mm,below right of=a] (c) {c};
\draw (a) -- (b);
\draw (a) -- (c);
\node[below=1.5cm of a, xshift=1.25cm] {ARS \#4};
\end{tikzpicture}
\end{center}
...
\draw (b) edge[bend left] (a);
\draw (a) -- (c);
\node[below=1.5cm of a, xshift=1.25cm] {ARS \#6};
\end{tikzpicture}
\end{center}
